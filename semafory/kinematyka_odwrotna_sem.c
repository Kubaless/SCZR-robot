...
/* otwarcie potoku gnuplota do zapisu */
...
int main(int argc,char * argv)
{
	...
	while (!must_stop)
	{
		...
		/* Obliczenie kinematyki odwrotniej i prostej, zapisanie obliczonych pozycji przegubow do pliku */
        ...
        {
            fprintf(gnuplotPipe, "%s \n", commandsForGnuplot[i]);  //Wyslanie odpowiednich komend do gnuplota 
        }
